...
class RecyclerViewUpdateTestActivity : AppCompatActivity() {
    ...
    private fun initView() {
        ...
        val adapter = RecyclerViewUpdateAdapter(this,list)
        mRecyclerView.adapter=adapter

        adapter!!.setOnItemClickListener(object:RecyclerViewUpdateAdapter.ItemClickListener{
